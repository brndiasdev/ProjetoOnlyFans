(function(){
    ...
    const botaoPlayer = document.querySelector('#audio5 .imagem-play');
    const botaoPause = document.querySelector('#audio5 .imagem-pause');
    const playerAudio = document.querySelector('#audio5 #player');
    const barraProgresso1 = document.querySelector('#audio5 .progresso>div:nth-child(1)');
    const barraProgresso2 = document.querySelector('#audio5 .progresso>div:nth-child(1)>div');
    const contadorProgresso = document.querySelector('#audio5 .progresso>p:nth-of-type(1)');

    let musica = true;
    playerAudio.src = "/static/audios/audio5.mp3";
