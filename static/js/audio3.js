(function(){
    ...
    const botaoPlayer = document.querySelector('#audio3 .imagem-play');
    const botaoPause = document.querySelector('#audio3 .imagem-pause');
    const playerAudio = document.querySelector('#audio3 #player');
    const barraProgresso1 = document.querySelector('#audio3 .progresso>div:nth-child(1)');
    const barraProgresso2 = document.querySelector('#audio3 .progresso>div:nth-child(1)>div');
    const contadorProgresso = document.querySelector('#audio3 .progresso>p:nth-of-type(1)');

    let musica = true;
    playerAudio.src = "/static/audios/audio3.mp3";
