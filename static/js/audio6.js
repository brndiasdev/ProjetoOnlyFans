(function(){
    ...
    const botaoPlayer = document.querySelector('#audio6 .imagem-play');
    const botaoPause = document.querySelector('#audio6 .imagem-pause');
    const playerAudio = document.querySelector('#audio6 #player');
    const barraProgresso1 = document.querySelector('#audio6 .progresso>div:nth-child(1)');
    const barraProgresso2 = document.querySelector('#audio6 .progresso>div:nth-child(1)>div');
    const contadorProgresso = document.querySelector('#audio6 .progresso>p:nth-of-type(1)');

    let musica = true;
    playerAudio.src = "/static/audios/audio6.mp3";
