(function(){
    ...
    const botaoPlayer = document.querySelector('#audio1 .imagem-play');
    const botaoPause = document.querySelector('#audio1 .imagem-pause');
    const playerAudio = document.querySelector('#audio1 #player');
    const barraProgresso1 = document.querySelector('#audio1 .progresso>div:nth-child(1)');
    const barraProgresso2 = document.querySelector('#audio1 .progresso>div:nth-child(1)>div');
    const contadorProgresso = document.querySelector('#audio1 .progresso>p:nth-of-type(1)');

    let musica = true;
    playerAudio.src = "/static/audios/audio1.mp3";
