(function(){
    ...
    const botaoPlayer = document.querySelector('#audio4 .imagem-play');
    const botaoPause = document.querySelector('#audio4 .imagem-pause');
    const playerAudio = document.querySelector('#audio4 #player');
    const barraProgresso1 = document.querySelector('#audio4 .progresso>div:nth-child(1)');
    const barraProgresso2 = document.querySelector('#audio4 .progresso>div:nth-child(1)>div');
    const contadorProgresso = document.querySelector('#audio4 .progresso>p:nth-of-type(1)');

    let musica = true;
    playerAudio.src = "/static/audios/audio4.mp3";
